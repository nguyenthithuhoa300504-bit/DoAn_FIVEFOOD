const fs = require('fs');
const cssPath = 'c:\\Users\\Admin\\Desktop\\DoAn\\frontend\\src\\index.css';
...
if (!cssContent.includes('FORCE FIX VOUCHER CARDS')) {
  fs.writeFileSync(cssPath, cssContent + '\n' + voucherFixCSS);
  console.log('Appended voucher fixes to index.css');
} else {
  console.log('Already in index.css');
}
